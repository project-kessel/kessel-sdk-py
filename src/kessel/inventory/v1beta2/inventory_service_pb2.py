...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_KESSELINVENTORYSERVICE'].methods_by_name['Check']._serialized_options = b'\202\323\344\223\002\036\"\031/api/kessel/v1beta2/check:\001*'
  _globals['_KESSELINVENTORYSERVICE'].methods_by_name['CheckSelf']._loaded_options = None
  _globals['_KESSELINVENTORYSERVICE'].methods_by_name['CheckSelf']._serialized_options = b'\202\323\344\223\002\"\"\035/api/kessel/v1beta2/checkself:\001*'
  _globals['_KESSELINVENTORYSERVICE'].methods_by_name['CheckForUpdate']._loaded_options = None
  _globals['_KESSELINVENTORYSERVICE'].methods_by_name['CheckForUpdate']._serialized_options = b'\202\323\344\223\002\'\"\"/api/kessel/v1beta2/checkforupdate:\001*'
  _globals['_KESSELINVENTORYSERVICE'].methods_by_name['CheckForUpdateBulk']._loaded_options = None
  _globals['_KESSELINVENTORYSERVICE'].methods_by_name['CheckForUpdateBulk']._serialized_options = b'\202\323\344\223\002+\"&/api/kessel/v1beta2/checkforupdatebulk:\001*'
  _globals['_KESSELINVENTORYSERVICE'].methods_by_name['CheckBulk']._loaded_options = None
  _globals['_KESSELINVENTORYSERVICE'].methods_by_name['CheckBulk']._serialized_options = b'\202\323\344\223\002\"\"\035/api/kessel/v1beta2/checkbulk:\001*'
  _globals['_KESSELINVENTORYSERVICE'].methods_by_name['CheckSelfBulk']._loaded_options = None
  _globals['_KESSELINVENTORYSERVICE'].methods_by_name['CheckSelfBulk']._serialized_options = b'\202\323\344\223\002&\"!/api/kessel/v1beta2/checkselfbulk:\001*'
  _globals['_KESSELINVENTORYSERVICE'].methods_by_name['ReportResource']._loaded_options = None
  _globals['_KESSELINVENTORYSERVICE'].methods_by_name['ReportResource']._serialized_options = b'\202\323\344\223\002\"\"\035/api/kessel/v1beta2/resources:\001*'
  _globals['_KESSELINVENTORYSERVICE'].methods_by_name['DeleteResource']._loaded_options = None
  _globals['_KESSELINVENTORYSERVICE'].methods_by_name['DeleteResource']._serialized_options = b'\202\323\344\223\002\"*\035/api/kessel/v1beta2/resources:\001*'
  _globals['_KESSELINVENTORYSERVICE']._serialized_start=1112
  _globals['_KESSELINVENTORYSERVICE']._serialized_end=2516
