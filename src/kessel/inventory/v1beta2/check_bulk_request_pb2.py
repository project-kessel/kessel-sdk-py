...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'kessel/inventory/v1beta2/check_bulk_request.proto'
)
...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'kessel.inventory.v1beta2.check_bulk_request_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CHECKBULKREQUESTITEM'].fields_by_name['object']._loaded_options = None
  _globals['_CHECKBULKREQUESTITEM'].fields_by_name['object']._serialized_options = b'\272H\003\310\001\001'
  _globals['_CHECKBULKREQUESTITEM'].fields_by_name['relation']._loaded_options = None
  _globals['_CHECKBULKREQUESTITEM'].fields_by_name['relation']._serialized_options = b'\272H\004r\002\020\001'
  _globals['_CHECKBULKREQUESTITEM'].fields_by_name['subject']._loaded_options = None
  _globals['_CHECKBULKREQUESTITEM'].fields_by_name['subject']._serialized_options = b'\272H\003\310\001\001'
  _globals['_CHECKBULKREQUEST'].fields_by_name['items']._loaded_options = None
  _globals['_CHECKBULKREQUEST'].fields_by_name['items']._serialized_options = b'\272H\010\222\001\005\010\001\020\350\007'
  _globals['_CHECKBULKREQUESTITEM']._serialized_start=254
  _globals['_CHECKBULKREQUESTITEM']._serialized_end=468
  _globals['_CHECKBULKREQUEST']._serialized_start=471
  _globals['_CHECKBULKREQUEST']._serialized_end=645
